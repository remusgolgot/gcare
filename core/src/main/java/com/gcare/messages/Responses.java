package com.gcare.messages;

public final class Responses {

    public static final String SUCCESSFULLY_ADDED_DOCTOR = "Doctor successfully created";
    ...
    public static final String SUCCESSFULLY_ADDED_DOCUMENT = "Document successfully created";

    public static final String SUCCESSFULLY_UPDATED_DOCTOR = "Doctor successfully updated";
    public static final String SUCCESSFULLY_UPDATED_DOCUMENT = "Document successfully updated";
    ...
    public static final String SUCCESSFULLY_DELETED_DOCUMENT = "Document successfully deleted";
    ...
    public static final String FAILED_TO_CREATE_DOCUMENT = "Could not create document";
    ...
    public static final String FAILED_TO_UPDATE_DOCUMENT = "Could not update document";
    ...
    public static final String FAILED_TO_DELETE_DOCUMENT = "Could not delete document";
    public static final String FAILED_TO_DELETE_PATIENT = "Could not delete patient";
    public static final String FAILED_TO_DELETE_CONSULTATION = "Could not delete consultation";

    public static final String DOCTOR_NOT_FOUND_FOR_ID = "Doctor not found for the given ID";
    public static final String DOCUMENT_NOT_FOUND_FOR_ID = "Document not found for the given ID";
