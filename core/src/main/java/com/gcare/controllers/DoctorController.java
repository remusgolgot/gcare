...
public class DoctorController {
    ...
    @PutMapping(value = "/{doctorID}", consumes = "application/json", produces = "application/json")
    @ResponseBody
    public ResponseEntity updateDoctor(@PathVariable(value = "doctorID") Integer doctorID,
